...
namespace local
{
    ...
    internal static class WebApiRequest
    {
        ...
        private const String SpongeJsUrlData = "https://agrohyd-api-dev.runlevel3.de/ParameterSetData/getByTagTypeLocation/{0}/climate/{1}/{2}/date%3A{3}?end=date%3A{4}&step=date%3A{5}&format=csv";
